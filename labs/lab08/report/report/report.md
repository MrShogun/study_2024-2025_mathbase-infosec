...
Сначала реализуем несколько функций (Рис.[@fig:001]): функцию, обладающую сжимающими свойствами; функцию по нахождению порядка числа в конечном поле, и функцию модульного экспоненциирования. Далее реализуем функцию $\rho$-метода Полларда для нахождения дискретного логарифма (Рис.[@fig:002]). После чего найдём дискретный логарифм для двух случаев: $10^{64} = x \mod 107$, $2^{22} = x \mod 29$ (Рис.[@fig:003]); в результате чего получим следующий вывод, представленный на Рис.[@fig:004].
