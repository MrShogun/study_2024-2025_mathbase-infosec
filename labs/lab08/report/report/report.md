...
4. Присвоить $w_{m+n-s+1} := t \mod b$, $t := \left\lfloor \frac{t}{b} \right\rfloor$, где $w_{m+n-s+1}$ - наименьший неотрицательный вычет по модулю $b$.
...
Сначала реализуем алгоритмы сложения и вычитания многоразрядных неотрицательных целых чисел (Рис.[@fig:001]), после чего реализуем алгоритмы умножения многоразрядных целых чисел столбиком (Рис.[@fig:002]), а также алгоритм быстрого столбика (Рис.[@fig:003]). Наконец, реализуем алгоритм деления многоразрядных целых чисел (Рис.[@fig:004]). Тогда для двух пар чисел: $u_1 = 6957, v_1 = 1423$ (Рис.[@fig:005]), $u_2 = 6957142, v_2 = 1423$ (Рис.[@fig:006]), получим следующий вывод, представленный на Рис.[@fig:007].
